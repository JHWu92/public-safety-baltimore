...
def main():
    ...
    from src.utils import metric_roc_like
    ...
    metrics = [
        metric_roc_like.hit_rate_upct, metric_roc_like.search_efficient_rate_upct,
        metric_roc_like.prediction_accuracy_index_upct, metric_roc_like.area_to_perimeter_ratio_upct,
        metric_roc_like.hit_rate_rbin, metric_roc_like.search_efficient_rate_rbin,
        metric_roc_like.prediction_accuracy_index_rbin, metric_roc_like.area_to_perimeter_ratio_rbin,
    ]
